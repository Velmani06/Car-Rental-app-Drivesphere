...
function RentalFleets() {
  ...
  return (
    <div
      className={`rental-fleets-container w-full min-h-screen bg-slate-500 flex flex-col justify-center items-center overflow-hidden ${
    ...
    >
      ...
      {/* View More Loader Button */}
      {isButton && (
        <div className="view-more w-full h-20 flex justify-center items-center">
          <button
          ...
          >
            <p
              className={`${
                isLoader ? "hidden" : "flex justify-center items-center"
              }`}
            >
